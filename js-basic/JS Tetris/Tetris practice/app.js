...
//the Tetrominoes
    ...
    //freeze tetromino at bottom function 
    function freeze() {
    ...
    function rotate(){
        undraw()
        currentRotation ++
        if (currentRotation === current.length) {   //if current rotation gets to 4, make it to go back to 0
            currentRotation = 0
        }
        current = theTetromino[random][currentRotation]
        draw()
    ...
    function displayShape() {
        //remove any trace of a tetromino form the enrire grid
